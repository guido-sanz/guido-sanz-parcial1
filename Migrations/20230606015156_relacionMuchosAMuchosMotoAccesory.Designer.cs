...
namespace guido_sanz_parcial1.Migrations
{
    ...
    [Migration("20230606015156_relacionMuchosAMuchosMotoAccesory")]
    partial class relacionMuchosAMuchosMotoAccesory
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("guido_sanz_parcial1.Models.Accesory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("MotoAccesory", b =>
                {
                    b.HasOne("guido_sanz_parcial1.Models.Accesory", null)
                        .WithMany()
                        .HasForeignKey("AccesoriesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("guido_sanz_parcial1.Models.Moto", null)
                        .WithMany()
